                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="AddCheckOut" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" name="payment_type" placeholder="payment_type" value="">
                                    </div>   
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="zipCode" placeholder="Zip Code" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="number" class="form-control" name="phone" min="0" placeholder="Phone No" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <textarea  class="form-control w-100" name="postcode_zip" cols="30" rows="10" placeholder="postcode_zip"></textarea>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            <input type="checkbox" class="custom-control-input" name="customCheck2">
                                            <label class="custom-control-label" for="customCheck2">Create an accout</label>
                                        </div>
                                        <div class="custom-control custom-checkbox d-block">
                                            <input type="checkbox" class="custom-control-input" name="customCheck3">
